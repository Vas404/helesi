 ...
 await Routes.findAll({
  ...
  exports.PrintWaste = (req, res) => {
        ...
        console.log(params)
          ...
          await page.goto('https://95.216.162.109/api/v1/setprintwaste/'+params)
          const options = {
  ...
  exports.PrintRoutes = (req, res) => {
    ...
    console.log(params)
      ...
      //was http://77.69.37.69:62625/api/v1/setprintwaste/
      const page = await browser.newPage()   
      await page.goto('https://95.216.162.109/api/v1/setprintroutes/'+params)
      const options = {
        //path: 'pdf/filename.pdf',
        format: 'A4',
        printBackground: true,
    ...
    exports.PrintSingleWaste = (req, res) => {
        ...
        // console.log(id)
          ...
          '--ignore-certifcate-errors-spki-list'],
            ...
            const page = await browser.newPage()   
            await page.goto('https://95.216.162.109/api/v1/setsinglewaste/'+id)

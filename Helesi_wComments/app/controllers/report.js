...
//waste report with jwt starting date and ending date, is called weekly monthly and for custom date
//returns in json form the objects that appear in waste.ejs after onclick Search or month, week buttons.
// with the adminId (id of the admin that created the user, who is currently operrating the app.)
...
//sends data back to the ejs [waste.ejs and routes.ejs] if and only if objects are in the lto network, otherwise, returns not found
...
//returns if the object exists in the lto network
...
//sets how the printfile for wastes is created
///////////////////////print report/////////////////////////////////////////////////////
...
//same as SetPrintFileWastes, but for routes
// not implemented adminId for routes
 ...
 await Routes.findAll({
  ...
  exports.PrintWaste = (req, res) => {
        ...
        console.log(params)
          ...
          await page.goto('https://95.216.162.109:443/setprintwaste/'+params)
          const options = {
  ...
  exports.PrintRoutes = (req, res) => {
    ...
    console.log(params)
      ...
      //was http://77.69.37.69:62625/api/v1/setprintwaste/
      const page = await browser.newPage()   
      await page.goto('https://95.216.162.109:443/setprintroutes/'+params)
      const options = {
        //path: 'pdf/filename.pdf',
        format: 'A4',
        printBackground: true,
    ...
    exports.PrintSingleWaste = (req, res) => {
        ...
        // console.log(id)
          ...
          '--ignore-certifcate-errors-spki-list'],
            ...
            const page = await browser.newPage()   
            await page.goto('https://95.216.162.109:443/setsinglewaste/'+id)
      ...
      exports.PrintSingleRoute = (req, res) => {
        ...
        // console.log(id)
          ...
          '--ignore-certifcate-errors-spki-list'],
            ...
            const page = await browser.newPage()   
            await page.goto('https://95.216.162.109:443/setsingleroute/'+id)
            const buffer = await page.pdf({format: 'A4'})
            res.type('application/pdf')
            browser.close()
            res.send(buffer) 
